...
- **Issues**: [GitHub Issues](https://github.com/ojolisa/Compliance-monitor/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ojolisa/Compliance-monitor/discussions)
...
- [ ] Custom compliance check definitions
...
**Compatibility**: Windows 10+, macOS 10.14+, Linux (systemd)
